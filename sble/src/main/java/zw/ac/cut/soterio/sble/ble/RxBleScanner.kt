...
class RxBleScanner(val context: Context, private val scope: CoroutineScope) {
    ...
    private val monitorFilter = com.polidea.rxandroidble2.scan.ScanFilter.Builder()
        .setServiceUuid(ParcelUuid(Constants.SBLE_SERVICE_UUID))
        .build()
    ...
    fun start() {
        appDatabase = DatabaseManager.getDatabase(context)
        ...
        scope.launch {
            scanResult
                ...
                .flatMapSingle { connection ->
                    ...
                    connection.readCharacteristic(Constants.SBLE_SERVICE_UUID)
                        .doOnSuccess{data ->
                            ...
                            */
                            ...
                            connection.writeCharacteristic(Constants.SBLE_SERVICE_UUID, identifier.toByteArray())
                                .doOnSuccess {
